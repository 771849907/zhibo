...
<div id="live">
     ...
     <div class="live-vedio">
          <ul>
              ...
              <li>
                  <a><img src="${ctx}/images/live_img/01.jpg">&nbsp;SLI群星联赛S2重播<span class="game">绝地求生&nbsp;</span><span class="live-user">&nbsp;imba绝地求生频
                  道</span></a></li>
              <li>
...
<div id="register">
    <div class="register-page">
    	<div class="register-close">
    		<a href="home.jsp">&times;</a>
    	</div><!-- register-close-->
    </div><!--register-page -->
    
    	<div class="main_nav">
			<ul>
				<li><a class="cd-signin" href="#"><span style="color:#ffcd02">注册</span></a></li>
				<li><a class="cd-signup" href="login.jsp">登录</a></li>
			</ul>
		</div><!--main_nav-->
        	 <div id="cd-login"> <!-- 注册表单 -->
				<form class="cd-form" method="post" action="user/register.do">
					<p class="fieldset">
						 <label for="username"></label>
						<input  id="signin-username"  type="username" name="username"placeholder=" 输入用户名">
					</p>

					<p class="fieldset">
						<label  for="password"></label> 
                        <input  id="signin-password" type="password" name="password" placeholder=" 输入密码">
                        <p class="fieldset">
						<label for="password"></label>
                        <input  id="signin-password-again" type="password" name="password" placeholder=" 请再次确认密码">
					</p>
                    <p class="fieldset">
						 <label  for="phone"></label>
						<input  id="input-test" type="phone" name="phone" placeholder=" 请输入您的电话号码">
                        </p>
                        <p class="fieldset">
						 <label  for="email"></label>
						<input  id="input-test" type="email" name="email" placeholder=" 请输入您的常用电子邮箱">
                        </p>
                    ...
                    <p class="fieldset" >
                        ...
                        <a href="home.jsp"><input class="full-width2" type="submit" value="注 册" ></a>
                        <a href="#"><input class="full-width3" type="reset" value="重置" ></a>
					</p>
				</form>
			</div> 
