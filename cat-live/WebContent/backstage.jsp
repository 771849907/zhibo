...
<html >
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/javascript/jquery-1.4.4.min.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/javascript/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/javascript/outlook2.js"> </script>
    <script type="text/javascript">
	
	 var _menus = {
		                 "menus":[
						           {"menuid":"1","icon":"icon-sys","menuname":"后台管理",
							      "menus":[
									{"menuid":"12","menuname":"用户管理","icon":"icon-page","url":"menu1/user.jsp"},
									{"menuid":"13","menuname":"直播管理","icon":"icon-role","url":"menu1/live.html"},
									{"menuid":"14","menuname":"视频管理","icon":"icon-class","url":"menu1/video.jsp"}
								    ]}
...
<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
      <div class="footer"> CATLIVE TV</div>
    </div>
...
<div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
    ...
    <div title="首页" style="padding:20px;overflow:hidden; color:red; " >
          <h1 style="font-size:24px;">欢迎使用猫视TV后台管理系统</h1>
        </div>
  </div>
    </div>
