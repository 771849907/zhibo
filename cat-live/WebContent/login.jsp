...
<div id="head">
	 ...
	 <div class="search">
        ...
        <!------------------注册-------------------->
        <div class="register"><img src="${ctx}/images/注册.png"><a href="register.jsp">注册</a></div>
	 </div>
</div>
...
<div id="login-in">
    ...
    <a href="home.jsp">&times;</a>
	 ...
	 <div class="main_nav">
			...
			<ul>
				<li><a class="cd-signin" href="#"><span style="color:#ffcd02">登录</span></a></li>
				<li><a class="cd-signup" href="register.jsp">注册</a></li>
			</ul>
		</div><!--main_nav-->
        
       <div id="cd-login"> <!-- 登录表单 -->
				<form class="cd-form" method="post" action="user/login.do">
					<p class="fieldset">
                    ...
                    <p class="fieldset">
                        ...
                        <a href="#"><input class="full-width2" type="submit" value="登 录" ></a>
                        
                        <a href="#"><input class="full-width3" type="reset" value="重 置" ></a>
					</p>
				</form>
			</div> 
</div><!-- login-in-->
